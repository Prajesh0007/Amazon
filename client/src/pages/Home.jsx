        ...
        <div className="bg-slate-50 min-h-screen pb-20 overflow-hidden">
            ...
            <div className="relative border-b border-slate-100 px-6 py-24 text-center overflow-hidden bg-white shadow-sm">
                ...
                <div className="max-w-4xl mx-auto space-y-10 relative z-10">
                    ...
                    <div className="flex items-center gap-6 bg-slate-50 rounded-full px-12 py-8 border border-slate-200 shadow-xl w-full max-w-2xl mx-auto mt-16 transition-all focus-within:ring-[20px] focus-within:ring-blue-500/5 hover:border-blue-500/30">
