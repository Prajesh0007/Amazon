...
import { Mail, Lock, User, ArrowRight, Github, Chrome, AlertCircle, Loader2, CheckCircle2, Eye, EyeOff } from 'lucide-react';
        ...
        >
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400/50" size={18} />
                <input
                  type={showPassword ? 'text' : 'password'}
                  required
                  className="input-field w-full pl-10 pr-12 transition-all duration-300"
                  placeholder="••••••••"
